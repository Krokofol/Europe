...
//                Collections.singletonList("Киберпанк")));
        ...
        Integer mashId = getUserId("Mashnila");
        createRoute(mashId, new Route(mashId));
        Integer mashRouteId = getRouteId(mashId, 1);
        createFlag(mashId, mashRouteId, new Flag(54.847260, 83.092349, 25, 1));
        createFlag(mashId, mashRouteId, new Flag(54.842958, 83.090939, 30, 1));
        createFlag(mashId, mashRouteId, new Flag(54.839313, 83.095359, 500, 2));
        //-------------------------------------------------------------------------------------------
    }
    ...
    public Integer getRouteId(Integer userId, Integer routeNumber){
        ...
        return array.get(routeNumber - 1).get_id();
    }
